<div class="mb-4">
    <button
        ...
        < Voltar à página de empresas
    </button>
    <input type="hidden" id="active-company" value="<?= $company->active ?? ""; ?>">
</div>
    
<form id="form" action="<?= url("/adicionarempresa") . (isset($company->id_enterprise) ? "/" . $company->id_enterprise : "" ) ?>" method="post" class="bg-white p-5 rounded-2xl">
    <?= csrf_input(); ?>
    <div class="">
        <div>
        ...
        <div class="col-span-4 flex justify-end mt-4 md:p-4 gap-3 pb-0">
