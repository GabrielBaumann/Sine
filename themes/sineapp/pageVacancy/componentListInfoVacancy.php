                ...
                <?php if($vacancyList):?>
                    <?php foreach($vacancyList as $vacancyItem): ?>
                        <tr class="hover:bg-gray-100">
                            ...
                            <td>
                                <a id="btn-detail-vacancy" data-url="<?= url("/detalhevaga/{$vacancyItem->id_vacancy}"); ?>" class="notform flex justify-center  text-blue-500 cursor-pointer hover:text-blue-900 transition-all duration-300">
