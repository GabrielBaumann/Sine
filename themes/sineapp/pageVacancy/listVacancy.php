        ...
        <div class="flex flex-col sm:flex-row gap-2">
            ...
            <?php elseif($checkPanelVacancy === 2): ?>
                <button 
                    ...
                    id="btn-hiden-panel" 
                    class="cursor-pointer flex items-center gap-2 bg-green-600 hover:bg-green-700 2xl:px-4 2xl:py-2 text-white font-medium rounded-lg transition-colors duration-200 shadow-sm">
