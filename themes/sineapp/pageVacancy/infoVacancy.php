<div class="flex flex-col md:flex-row md:items-center md:justify-between gap-6 pt-2">
    <div class="flex-flex-col">
        ...
        <input type="text" value="<?= $vacancyInfo->id_vacancy; ?>">
    </div>
                ...
                <?php foreach($vacancyList as $vacancyItem): ?>
                    <tr class="hover:bg-blue-100">
                        <td class="whitespace-nowrap">
                            <input type="checkbox" id="<?= $vacancyItem->id_vacancy; ?>" class="check-vacancy h-4 w-4 ml-3 rounded border-gray-300 text-blue-600 focus:ring-blue-500">
                        </td>
