                        ...
                        <select 
                            ...
                            <option value="">Empresa</option>
                                <?php foreach($companys as $company): ?>        
                                    <option value="<?= $company->id_enterprise; ?>" <?= ($enterprise->findById($vacancy->id_enterprise)->name_enterprise ?? null) === "{$company->name_enterprise}" ? "selected" : "" ?>><?= $company->name_enterprise; ?> <?= $company->type_document === "CPF" ? formatCPF($company->cnpj_cpf) : maskCNPJ($company->cnpj_cpf); ?></option>
                                <?php endforeach; ?>
                        </select>
                    <?php else:?>
                        <select 
                            ...
                            <option value="">Empresa</option>
                                <?php foreach($companys as $company): ?>        
                                    <option value="<?= $company->id_enterprise; ?>"><?= $company->name_enterprise; ?> <?= $company->type_document === "CPF" ? formatCPF($company->cnpj_cpf) : maskCNPJ($company->cnpj_cpf); ?></option>
                                <?php endforeach; ?>
                        </select>
                    <?php endif; ?>
                </div>
