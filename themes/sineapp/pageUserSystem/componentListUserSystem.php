<div class="overflow-x-auto bg-white rounded-2xl p-5">
                ...
                <?php foreach($users as $user): ?>
                    <tr class="hover:bg-blue-50 border-b border-gray-300">
                        ...
                        <td data-label="Tipo de Acesso" class="px-6 py-2 whitespace-nowrap">
                            <span class="status-user-system color-user text-sm text-blue-800 bg-blue-200 rounded-full px-2.5 py-0.5"><?= ($user->active === 1) ? "Ativo" : "Cancelado" ; ?></span>
                        </td>
                        ...
                        <td data-label="Ação" class="px-6 py-2 whitespace-nowrap text-right text-sm font-medium">
                            <div class="flex justify-end">
                                <button 
                                    id="btn-form" 
                                    data-url="<?= url("/editarusuario/{$user->id_user}") ?>"
                ...
                <tr class="h-full">
                    <td colspan="5" class="px-4 py-8 text-center text-gray-500">
                        <div class="flex flex-col items-center justify-center gap-2">
                            ...
                            <p class="text-sm text-gray-400">Os usuários aparecerão aqui quando forem criados</p>
                        </div>
                    </td>
                </tr>
            <?php endif;?>
...
<div class="px-4 py-3 flex items-center justify-between sm:px-6">
    <div class="hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
        ...
        <div>Total: <?= format_number($userCount ?? 000) ?></div>
    </div>
</div>