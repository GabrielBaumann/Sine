...
<div class="flex-1 flex flex-col lg:flex-row overflow-hidden pb-16 lg:pb-0">
  <main class="flex-1 p-4 lg:p-6 overflow-y-auto">
    ...
    <div class="relative mb-4 lg:mb-6">
      ...
      <input type="text" class="block w-full pl-10 pr-12 py-2 border border-gray-300 rounded-lg bg-white focus:outline-none focus:ring-1 focus:ring-sine-500 focus:border-sine-500" placeholder="Pesquisar candidatos...">
