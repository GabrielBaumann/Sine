    ...
    <div class="md:bg-white rounded-2xl grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 p-4 w-full justify-center">
      ...
      <div class="bg-blue-500 rounded-md p-4 2xl:p-6 overflow-hidden relative">
        <div class="flex justify-between items-start">
            ...
            <div class="p-2">
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="size-6 2xl:absolute 2xl:bottom-[-30px] 2xl:right-[-30px] 2xl:size-30 text-blue-200">
