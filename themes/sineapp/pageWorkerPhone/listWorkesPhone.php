<div class="overflow-hidden mt-5 bg-white p-5 rounded-2xl">
        ...
        <table class="min-w-full divide-y divide-gray-200 responsive-table">
            <thead class="text-gray-900">
                <tr>
                    ...
                    <th scope="col" class="px-6 py-3 text-left text-xs font-medium uppercase tracking-wider">Atendimento</th>
                        ...
                        <tr class="hover:bg-blue-50 border-b border-gray-300">
                            <td data-label="Nome" class=" whitespace-nowrap">
                                <div class="flex items-center">
                                    <div class="ml-4">
                                        <div class="text-sm font-medium text-gray-900"><?= $worksPhoneitem->name_work_phone; ?></div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td data-label="Tipo de Acesso" class="px-6 py-2 whitespace-nowrap">
                                <span class="color-user text-sm text-black-800 rounded-full px-2.5 py-0.5"><?= $worksPhoneitem->type_service; ?></span>
                            </td>
                            
                            <td data-label="Ação" class="px-6 py-2 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex justify-end">
                                    <button id="btn-edit" data-url="<?= url("/abriratendimento/" .  $worksPhoneitem->id_worker); ?>" 
