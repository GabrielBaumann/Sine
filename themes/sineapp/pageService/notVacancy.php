<div id="step-5" class="step-content">
    <div class="text-center py-8 px-4">
        ...
        <h2 class="text-2xl text-gray-900 mb-3">Não há vagas cadastradas!</h2>
        <p class="text-gray-900 mb-8 max-w-md mx-auto">Cadastre vagas para fazer encaminhamentos.</p>
