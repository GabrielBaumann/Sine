<div id="step-1" class="step-content">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            class="shadow-xl cursor-pointer p-6 border-2 border-gray-300 rounded-lg hover:border-gray-300 hover:bg-blue-100 transition-all flex flex-col items-center gap-3">
        ...
        <button class="shadow-xl cursor-pointer p-6 border-2 border-gray-300 rounded-lg hover:border-gray-300 hover:bg-blue-100 transition-all flex flex-col items-center gap-3">
