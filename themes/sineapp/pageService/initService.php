<div id="step-1" class="step-content">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 border-none">
        ...
        <button
            ...
            class="cursor-pointer p-6 border border-gray-300 shadow-xl rounded-lg hover:bg-gray-200 hover:shadow-sm transition-all flex flex-col items-center gap-3">
