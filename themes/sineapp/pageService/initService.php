...
<<<<<<< HEAD
            ...
            class="cursor-pointer p-6 border-2 border-gray-300 rounded-lg hover:border-gray-300 hover:bg-gray-100 transition-all flex flex-col items-center gap-3">
=======
...
>>>>>>> 8ab4962613f08587ba44e452ed7794e93e5a5fc4
...
<<<<<<< HEAD
        <button 
            ...
            class="cursor-pointer p-6 border-2 border-gray-300 rounded-lg hover:border-gray-300 hover:bg-gray-100 transition-all flex flex-col items-center gap-3">
=======
        <button class="cursor-pointer p-6 border border-gray-300 rounded-lg hover:bg-gray-300 transition-all flex flex-col items-center gap-3">
>>>>>>> 8ab4962613f08587ba44e452ed7794e93e5a5fc4
