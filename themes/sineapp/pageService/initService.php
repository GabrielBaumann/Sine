<div id="step-1" class="step-content">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4 border-none mt-10 p-5">
        ...
        <button 
            ...
            class="bg-gradient-to-r from-blue-500 to-blue-600 cursor-pointer p-5 border border-gray-300 hover:shadow-xl rounded-lg hover:bg-gray-200 shadow-sm transition-all flex flex-col items-center gap-3">
            <div class="w-7 h-7 flex items-center justify-center text-white">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-10">
