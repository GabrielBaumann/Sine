...
<body>
    <div id="visualizar-container" class="flex items-center justify-center gap-3">
        <button id="visualizar-pdf" class="flex gap-2 bg-red-500 p-2 text-white font-semibold rounded-md cursor-pointer hover:bg-red-600">
        ...
        <a href="<?= url("/baixarpainelword") ?>">
            <button class="flex gap-2 bg-blue-500 p-2 text-white font-semibold rounded-md cursor-pointer hover:bg-blue-600">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6">
...
<<<<<<< HEAD
        <button id="visualizar-jpeg" class="flex gap-2 bg-yellow-500 p-2 text-black font-semibold rounded-md cursor-pointer hover:bg-yellow-600">
=======
